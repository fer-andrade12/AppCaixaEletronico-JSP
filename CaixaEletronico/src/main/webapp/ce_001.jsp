	...
	<div>
		<form action="ce_002.jsp" method="post">
			<table>
				<tr>
					<td>Agência</td>
					<td><input type="text" name="agencia" size=1 required
						class="mask-agencia"></td>
				</tr>
				<tr>
					<td>Conta Corrente</td>
					<td><input type="text" name="conta" size=2 required
						class="mask-conta"></td>
				</tr>
				<tr>
					<td>Operação</td>
					...
					</select> <label id="tit" style="display: none">Número documento</label> <input
						type="text" id="doc" name="documento" size=6
						class="mask-documento" style="display: none"></td>
				</tr>
				<tr>
					<td>Valor</td>
					<td><input type="text" name="valor" required class="mask-real"
